var searchTrainingOrganizations = Vue.component('searchmediator', {
    props: {
    ...
    data: function () {
        return {
            //Search object
            MediatorFilters: new MediatorFilters(),
            AllowedActions: [],
    ...
    methods: {
        ...
        getHeaders() {
            ...
            var headers = [
                ...
                /*{ text: 'Стац. тел.', value: 'MediatorContacts.LandlinePhone', width: "10%" },
                { text: 'Моб. тел.', value: 'MediatorContacts.MobilePhone', width: "10%" },
                { text: 'Факс', value: 'MediatorContacts.Fax', width: "10%" },
                { text: 'Ел. поща', value: 'MediatorContacts.Email', width: "15%" },*/
...
function mediatorsSearch(vue, _page) {
    ...
    makeServerCall('POST', '/Mediators/SearchMediators', { page: page, perpage: rowsPerPage, filters: vue.MediatorFilters }, (ResultData) => {
